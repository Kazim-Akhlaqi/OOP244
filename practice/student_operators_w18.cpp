 ...
 // 1. operator == (helper function: a friend function of the class) 
 ...
 class Student {
    ...
    // alternative design: helper function/friend function
...
//bool operator==( const Student&, const Student&); // a helper function,
...
for (int k=0; k<counter; ++)
 ...
 int main (void) {
     ...
     // Part 1
/* 
     cout << "### Operator Overloading - Helper/Friend Functions ###" << endl;
